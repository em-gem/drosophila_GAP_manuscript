# ============================================================================
# PUBLICATION FIGURE GENERATION SCRIPT - UPDATED
# Generates high-quality figures from analyzed Seurat object
# Author: [Your name]
# Date: [Date]
# ============================================================================
...
seurat_object_path <- "C:/Users/980 Analysis/Documents/Emily_RNAseq_dge_with_transgenes/merged_seurat_object_100k_barcodes_leiden_res2_kparam.rds"

# Output directory for figures
output_dir <- "C:/Users/980 Analysis/Documents/Emily_RNAseq_dge_with_transgenes/100k_barcodes_leiden_res2_kparam_01212026"
...
# ============================================================================
# 1. HEATMAP OF TOP 25 GENES PER CLUSTER - FIXED ASPECT RATIO
# ============================================================================
...
# ============================================================================
# 4. FEATURE PLOTS (UMAP) - FIXED ASPECT RATIO
# ============================================================================
...
if (length(marker_defined_cells) > 20) {  # Need at least some cells
  ...
  # CREATE HEATMAP - FIXED HEIGHT FOR READABILITY
  ...
  heatmap_height_marker <- max(12, n_genes_marker / 25)  # More generous spacing
  ...
  # CREATE EXPRESSION MATRIX FOR EXPORT
...
# ============================================================================
# 7. ORIGINAL TRANSGENE ANALYSIS (keeping for compatibility)
# ============================================================================
...
if (has_LifeAct || has_dsRed) {
  ...
  if (length(transgene_cells) > 50) {  # Only proceed if enough cells
    ...
    # HEATMAP for transgene+ cells - FIXED HEIGHT
...
# ============================================================================
# 11. ANNOTATE CELL TYPES BY CLUSTER (ORIGINAL METHOD)
# ============================================================================
...
# ============================================================================
# 17. RHOGTPASE AND RELATED GENES FEATURE PLOTS (OVERLAID)
# ============================================================================
